...
<tr>
	<td><button><a href="hapus.php?id=<?=$row["id"]; ?>" onclick="return confirm('yakin');" style="text-decoration: none; color:green;">hapus data</a></button>
...
<footer >
 <p style="text-align: center; color: yellow;"> &copy;Deo Saputra</p>
</footer>
</html>
